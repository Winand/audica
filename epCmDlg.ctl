...
Public cFileName As New Collection   'Filename collection
Public cFileTitle As New Collection  'Filetitle collection
...
Public Sub ClearECD()
Dim i As Long
If cFileName.Count <= 0 Then Exit Sub
For i = 1 To cFileName.Count                'Кол-во выполнений = кол-во элементов
    cFileName.Remove (cFileName.Count)  'Удаляем каждый раз последний элемент
Next i
End Sub
